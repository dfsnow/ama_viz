...
ggplot() +
  ...
  labs(
    ...
    subtitle = paste0(
      "Measuring physician density per 100k people, the South, Southwest, and Great\n",
      "Plains all face a shortage of both specialists and primary care providers"),
    caption = "Source: American Medical Association Master File"
  ) +
  theme_void() +
  theme_ama() +
...
ggplot() +
  ...
  scale_size_continuous(name = "# of Graduates", range = c(1, 8)) +
  labs(
