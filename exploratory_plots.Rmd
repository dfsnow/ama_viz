---
title: "The Coming Crisis: Exploring the U.S. Physician Shortage"
author: "By Daniel Snow"
...
READER: My reader is the new Deputy Secretary of Health and Human Services. Her job is to be concerned about national health, so the rural doctor shortage is extremely relevant to her. She wants to be briefed on the nature of the shortage and what can be done to ameliorate it. She may be resistant to criticisms of current HHS policy and to eschewing academic consensus.
...
In response to this crisis, the Department of Health and Human Services (HHS) has enacted policies designed to stem the flow of physicians moving to urban areas. In 2000, HHS raised the Medicare reimbursement rate for rural doctors by 10%. The aim of this policy was to attract new doctors to rural areas by offering them a slight wage premium, and to keep rural doctors rural by offsetting their opportunity costs. 

Such policies misunderstand the nature and causes of the rural doctor shortage. The rural doctor shortage is not a result of rurality *per se*, but rather of the urban/rural education and class divide. In short, doctors have an overriding preference for urban areas because urban areas, like doctors, tend to be richer and highly educated. Current policies aimed at changing this preference have been unsuccessful because class is a mostly immutable characteristic. Paying doctors more in rural areas will not override their desire to be around other doctors and highly educated people. Instead, policymakers concerned about the rural doctor shortage should focus on recruiting doctors with pre-developed preferences for rural areas and on finding appropriate doctor substitutes, such as nurse practitioners.

Continuing current HHS policies will waste millions of dollars and will do little to ameliorate the rural doctor shortage or improve rural health. HHS should pivot toward a new set of policy solutions based on a more nuanced understanding of the shortage and its causes. To that end, the rest of this document is split into three parts: first, describing where the shortage actually is and what its causes are; second, discussing why current policies have failed; and third, offering new potential solutions.

# Mapping the U.S. Doctor Shortage {#part1}

Effective policy responses begin by correctly identifying the problem they're trying to solve. Policymakers, health professionals, and academics have spent decades studying the spatial distribution of physicians. As early as the 1960s, academics such as Rimlinger and Steele (1961) lamented the shortage of rural U.S. physicians and its potential impact on rural health. Since then, countless academics have updated the methods used for quantifying the shortage, but their shared definition of the shortage as rural has remained the same (where rural typically means population density).

Unfortunately, this definition is incomplete. While it's generally true that rural areas have fewer doctors, there are also rural areas with a high number of doctors relative to their population. These oversupplied areas aren't just small anomalies, they're often entire regions of the United States. The map below shows the physician-to-population ratio (physicians per 100K people) of each U.S. state. The ratio is grouped into quantiles for easier viewing. Most rural southern states (Mississippi and Arkansas) and plain states (Iowa, Nebraska) *do* have a low number of doctors relative to their population. However, notably rural regions such as the Pacific Northwest (Washington, Oregon) and the far Northeast (Maine, Vermont) are oversupplied. 

This distribution indicates that the rural doctor shortage is not driven entirely by rurality, but rather by a combination of rurality and other factors such as educational attainment level. Research by Wang (2016) shows that educational attainment explains over 40% of the geographic variation in physician supply, while population density (rurality) explains less than 10%. In other words, physicians tend to live in highly educated areas while only marginally considering rurality. As such, the rural doctor shortage is better characterized as a less-educated area doctor shortage. Academics focused on "rurality" as the determinant of doctor shortages were studying and creating fixes for the wrong problem. Rural areas do have doctor shortages, but they're largely caused by rural areas being less-educated, rather than by rurality itself. Academics and policymakers have misidentified the shortage for decades, attributing it to rurality when the truth was more nuanced. 
...
The true nature of the physician shortage can be seen more clearly at the county level. The map below shows the relative level of primary care accessibility for every county in the United States. This accessibility measurement uses a relatively new technique to minimize the driving time and cost of congestion for each patient. In other words, the algorithm chooses the nearest and least-crowded doctor for all patients, *accounting for the doctor choice of all other patients*. 
...
The results from this new method support the Wang's contention that physicians prefer to live in highly educated areas. On the map, this can be seen most clearly in the New England region. Maine, Vermont, and New Hampshire have excellent primary care accessibility despite being relatively rural states. Similarly, states in the upper Midwest such as Minnesota, Wisconsin, and Iowa are highly accessible despite being mostly rural. All of these states contain a large number of highly educated people relative to their population. Conversely, Texas and much of the South have poor accessibility despite being relatively more urban. These areas have lower average educational attainment than the rest of the U.S.

Places that are extremely rural yet highly educated are particularly interesting case studies. Jackson Hole, Wyoming is a famously wealthy ski town that attracts well-heeled, well-educated people from around the country. It is also quite rural, with a population of only 10,000 permanant residents. Based solely on its rurality, Jackson Hole should have about 25 doctors per 100K people. However, it actually has around 300 doctors per 100K people, among the highest number of physicians per capita in the country. According to survey data, physicians stay in Jackson Hole because there is demand for their services and because they find their patients and peers agreeable. This mirrors the national trend; the most highly educated and wealthy places in the U.S. attract the most doctors. 

Doctors are not alone in their preference for like-minded people. Recent literature, such as Bill Bishop's The Big Sort, has empirically demonstrated that people are increasingly self-sorting into homogeneous communities based on class and ideology. Sociologists and economists call this self-sorting "homophily," i.e. the tendency of people to bond and interact with those similar to themselves. Research has shown that homophily is extremely powerful and can override strong geographic and economic preferences. For doctors, homophily typically means choosing to live in urban areas among other doctors and educated people, even if that choice comes at the expense of higher wages and quality of life in a comparable rural area. In this sense, homophily explains not only the current distribution of physicians, but also why the policies of HHS and others have been so ineffective. they've been targeting the wrong problem. 
...
# Doctor Preferences and the Current Policy Response {#part2}

The Department of Health and Human Services (HHS) and various medical schools have spent millions of dollars trying to solve the rural doctor shortage. Unfortunately, their efforts are misguided and focused on the wrong problem. With the guidance of academia, HHS and medical schools have acted under the assumption that geographic variation in physician supply is driven by rurality itself. They have each attempted to change physician preferences for rurality but have ignored physicians' strong homophily and preference for educated areas. As a result, each of their respective policy ideas was ineffective and is now a wildly expensive boondoggle.  

To its credit, HHS was the first federal organization to act on the rural physician shortage. In 2000, they began to offer Medicare bonus payments of roughly 10% to providers operating in designated health care provider shortage areas. The goal of these payments is to incentivize physicians to move to rural areas by offsetting their input and opportunity costs. However, these payments have not worked as intended. Since 2000, the wage gap between urban and rural doctors has expanded dramatically, and rural doctors now make roughly $40K *more* than their urban counterparts. Despite this, the rural doctor shortage has only worsened. 

HHS failed to recognize the importance of cultural and class factors linked to becoming a doctor. Doctors, by the nature of their education and societal status, are in an elite class. Like most people, they have a strong sense of homophily and want to work and live among people like themselves. As a result, doctors have an overriding preference for living in cities and other highly educated areas. HHS tried to subvert this preference using wage incentives without fully understanding *why* doctors weren't moving to rural areas. 

Furthermore, even though rural doctors net more money, the profit margins of rural hospitals tend to be thin, most are barely staying afloat. Ending the subsidy would likely cripple the already-struggling medical infrastructure of rural America. As a result, HHS is now stuck subsidizing rural doctors and hospitals for hundreds of millions of dollars per year.
...
wages_data <- read_dta("data/acs_pers_phys.dta") %>%
  ...
  mutate_at(vars(year, age, perwt), list(as.numeric))
...
The worsening maldistribution of U.S. physicians has potentially disastrous health consequences for millions of Americans. States and the medical community should act quickly to implement practical solutions that increase the recruitment of rural medical students and NPs. 
